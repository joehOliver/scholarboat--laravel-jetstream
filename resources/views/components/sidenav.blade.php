 ...
 md:hidden">
 <nav class="col-span-3 flex flex-col pt-24 px-8 justify-start md:hidden bg-white shadow-2xl">
     ...
     <a class="text-3xl font-bold py-3 text-blue-darkest" href="/institutions">Institutions</a>
     <a class="text-3xl font-bold py-3 text-blue-darkest" href="/about">About</a>
     
     @auth
         <!-- check login admin profile settings -->
     ...
     <div class="flex md:hidden @guest pt-20 @endguest @auth hidden @endauth">
         <a href="https://www.facebook.com/ScholarBoatPH" aria-label="Facebook" target="_blank" rel="noopener noreferrer" class="p-3 social-icon">
         ...
         <a href="https://twitter.com/ScholarboatPH" aria-label="Twitter" target="_blank" rel="noopener noreferrer" class="p-3 social-icon">
             <svg class="default-icon" width="36" height="36" role="img" xmlns="http://www.w3.org/2000/svg"
                 viewBox="0 0 24 24">
             ...
             <a href="https://www.instagram.com/scholarboatph/" aria-label="Instagram" target="_blank" rel="noopener noreferrer" class="p-3 social-icon">
